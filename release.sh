...
# Push the podspec to the trunk (if enabled)
# TODO: Uncomment this line when ready for production release
# pod trunk push "$PODSPEC_PATH" --allow-warnings --verbose
echo "⚠️  Skipping CocoaPods trunk push (currently disabled for testing)"
